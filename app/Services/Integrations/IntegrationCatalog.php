...
class IntegrationCatalog
{
    public const PROVIDERS = [
        ...
        'credit_bureau' => ['category' => 'Wirtschaftsauskunftei (Creditreform/SCHUFA vorbereitet)', 'name' => 'Manuelle Bonitaetspruefung (Sandbox)'],
        'credit_insurance' => ['category' => 'Warenkreditversicherung (monatliche Linienmeldung vorbereitet)', 'name' => 'Manuelle Versicherungsmeldung (Sandbox)'],
